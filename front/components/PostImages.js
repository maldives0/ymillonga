        ...
        return (
            <>
                <div>
                    ...
                    <img role="presentation" style={{ width: '50%', display: 'inline-block' }} src={`${backUrl}/${images[1].src}`} alt={images[0].src} onClick={onZoom} />
                </div>
                {showImagesZoom && <ImagesZoom images={images} onClose={onClose} />}
            </>
        );
        ...
        <>
            <div>
                ...
                <div
                    role="presentation"
                    style={{
                        display: 'inline-block', width: '50%', textAlign: 'center',
