export const backUrl = process.env.NODE_ENV === 'production' ? "http://http://15.165.249.3" : "http://localhost:3051";
...
export const callbackUrl = process.env.NODE_ENV === 'production' ? "http://http://15.165.249.3/user/google/callback" : "http://localhost:3051/user/google/callback";
